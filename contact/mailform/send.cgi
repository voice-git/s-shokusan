...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'info@s-shokusan.com';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = '../thanks.html';

#08.設置者に届くメールの件名
$conf{'subject'} = '【HP】ホームページからお問い合わせをいただきました。';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '【シラエ織産】お問い合わせありがとうございます。';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
このたびは、シラエ織産にお問い合わせいただき
誠にありがとうございます。
下記の内容でお問い合わせを承りました。
...
tel.076-281-0447 / 　fax.076-282-5705
info@s-shokusan.com
━━━━━━━━━━━━━━━━━━━━━━━━━━
__res_body_eof__
